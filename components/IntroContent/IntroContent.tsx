...
export const IntroContent = ({ firstName }: IntroContentProps) => (
  <div className="flex flex-col items-center">
    ...
    <div className="leading-normal space-y-3 my-[10px] text-ash-900">
      <p>Dear {firstName},</p>
      <p>{content.intro}</p>
      ...
      <ul className="list-none space-y-2 pl-3">
        {content.howItWorks.points.map((point, idx) => {
          ...
          return (
            <li key={key} className="relative pl-4 before:content-[''] before:absolute before:left-0 before:top-[11px] before:h-0.75 before:w-0.75 before:bg-ash-900">
              {point}
            </li>
          )
        })}
